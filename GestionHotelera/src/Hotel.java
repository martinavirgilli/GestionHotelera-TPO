...
public class Hotel {
    ...
    public void mostrarReservas() {
        ...
        for (Reserva reserva : reservas) {
            System.out.println("Reserva: " + reserva.getCliente().getNombre() + " en la habitación " + reserva.getHabitacion().getNumero() + " desde " + dateFormat.format(reserva.getFechaInicio()) + " hasta " + dateFormat.format(reserva.getFechaFin()));
        }
    }
}
